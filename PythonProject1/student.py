...
st.title("Darsgah Taleemul Quran Wal Hadith Kongamdara")
...
if "syllabus" not in st.session_state:
    st.session_state["syllabus"] = {
        ...
        "Class 4": "1-10_merged.pdf",
        "Class 5": "1-10_merged.pdf",
        "Class 6": "1-10_merged.pdf",
        "Class 7": "1-10_merged.pdf",
        "Class 8": "1-10_merged.pdf"
    }
...
if choice == "Home":
    ...
    # Display Logo
    logo_path = 'meer.png'  # Update this path with your actual logo image file path or URL
    st.image(logo_path, width=50,use_container_width=True)  # Adjust width as needed

    st.markdown('<p class="front-description">This portal helps manage student records, attendance, and more for the institution. Explore the options below to interact with the system.</p>', unsafe_allow_html=True)
    ...
    if login_button:
        ...
        if not student_data.empty:
            ...
            if marks:
                ...
                # Iterate over each subject to calculate term-wise marks and overall result
                for subject, scores in marks.items():
                    ...
                    # Prepare the result lines for each subject
                    result_lines.append(f"{subject} - Term 1: {term1_obtained}/{term1_max}, Term 2: {term2_obtained}/{term2_max}")
