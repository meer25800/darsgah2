...
# Custom White Header
    ...
    if login_button:
        ...
        <div class="marks-box">
            {' '.join(result_lines)}
            <hr>
            <b><span style='color: #ffffff;'>Total:</b> <span style='color: #5200ff;'>{total_obtained}/{total_max}<br>
            <b><span style='color: #ffffff;'>Percentage:</b> <span style='color: #5200ff;'>{percentage:.2f}%<br>
            <b><span style='color: #ffffff;'>Result:</b><span style='color: #5200ff;'> {result}</b><br>
            <b><span style='color: #ffffff;'>Position:</span></b><span style='color: #5200ff;'> {student_info.get('Position', 'Not Assigned')}
        </div>
    """, unsafe_allow_html=True)
