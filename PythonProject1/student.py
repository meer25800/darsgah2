...
st.markdown('<div class="front-title-container"><div class="front-title" style="color: #ffffff; style= "font-size":60px;"> درسگاہ تعلیم القرآن والحدیث  کونگم ڈارہ </div></div>', unsafe_allow_html=True)
